            ...
            {filteredQuestions.map((question, index) => {
              ...
              return (
                <Card key={question.id} className={`group relative overflow-hidden transition-all duration-200 cursor-pointer ${
                  !['val-medium-nuvia-1', 'val-hard-normalize-1', 'val-medium-wesley-comps-1', 'val-easy-alto-comps-1', 'val-hard-wacc-solara-1', 'val-hard-wacc-axis-1', 'val-easy-wacc-basic-1', 'val-medium-wacc-tiered-1'].includes(question.id)
