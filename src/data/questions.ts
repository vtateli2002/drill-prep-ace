...
export const QUESTIONS: Question[] = [
  ...
  // ACCOUNTING - Hard
  {
    ...
    explanation: 'CFO = Net Income + Amortization + Increase in Deferred Revenue\nCFO = $50,000 + $20,000 + $40,000 = $110,000\n\nAmortization is a non-cash expense that reduces net income but doesn\'t affect cash.\nDeferred revenue represents cash collected but not yet recognized as revenue.',
    learnContent: {
  ...
  },
  {
    ...
    explanation: 'CFO = Net Income + Depreciation - ∆AR + ∆Inventory - ∆Prepaids + ∆AP - ∆Accruals\nCFO = $70,000 + $15,000 - $25,000 + $10,000 - $5,000 + $20,000 - $8,000 = $77,000',
    learnContent: {
