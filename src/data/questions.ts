...
• Final WACC = 5.76% + 0.70% + 1.40% = 7.86%`,
    learnContent: {
      ...
      howItWorks: '• Calculate capital weights for equity, debt, and preferred stock\n• Determine cost of equity using CAPM\n• Apply after-tax cost to debt (tax-deductible interest)\n• Use fixed dividend rate as cost of preferred equity\n• Weight each component by proportion of total capital',
...
5. Final WACC = 0.65 × 12.80% + 0.35 × 4.05% = 8.32% + 1.42% = 9.73%`,
    learnContent: {
      ...
      howItWorks: '• Calculate capital weights (equity and debt proportions)\n• Determine cost of equity using CAPM with market and country risk premiums\n• Calculate weighted average cost of debt across different instruments\n• Apply tax shield to debt cost since interest is tax-deductible\n• Combine weighted equity and debt costs for final WACC',
